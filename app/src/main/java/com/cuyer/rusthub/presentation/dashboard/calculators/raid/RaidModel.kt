...
fun RaidModel.create(): List<RaidModel> {
    ...
    raidModelList.add(RaidModel(image = WOODEN_DOOR_IMAGE, type = "Doors", explosives = Explosives().woodenDoor()))
    raidModelList.add(RaidModel(image = METAL_DOOR_IMAGE, type = "Doors", explosives = Explosives().metalDoor()))
    raidModelList.add(RaidModel(image = ARMORED_DOOR_IMAGE, type = "Doors", explosives = Explosives().armoredDoor()))
    raidModelList.add(RaidModel(image = GARAGE_DOOR_IMAGE, type = "Doors", explosives = Explosives().garageDoor()))
    raidModelList.add(RaidModel(image = LADDER_HATCH_IMAGE, type = "Doors", explosives = Explosives().ladderHatch()))
    raidModelList.add(RaidModel(image = SHOP_FRONT_IMAGE, type = "Walls", explosives = Explosives().shopFront()))
    raidModelList.add(RaidModel(image = WOODEN_EXTERNAL_WALL, type = "Walls", explosives = Explosives().woodenExternalWall()))
    raidModelList.add(RaidModel(image = STONE_EXTERNAL_WALL, type = "Walls", explosives = Explosives().stoneExternalWall()))
    raidModelList.add(RaidModel(image = WOODEN_WALL, type = "Walls", explosives = Explosives().woodenWall()))
    raidModelList.add(RaidModel(image = STONE_WALL, type = "Walls", explosives = Explosives().stoneWall()))
    raidModelList.add(RaidModel(image = METAL_WALL, type = "Walls", explosives = Explosives().metalWall()))
    raidModelList.add(RaidModel(image = ARMORED_WALL, type = "Walls", explosives = Explosives().armoredWall()))
