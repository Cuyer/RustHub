...
class ScrapOutputAdapter(private val scrapData: MutableList<ScrapItems>, context: Context): RecyclerView.Adapter<ScrapOutputAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.parentAmount.text = scrapData[position].amount.toDouble().toInt().toString()
        Picasso.get()
    ...
    fun removeItems() {
        scrapData.removeAll(scrapData)
        ScrapDataHolder.removeData()
